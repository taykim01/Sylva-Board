...
export const BaseTextEditor = forwardRef<BaseTextEditorRef, BaseTextEditorProps>((props, ref) => {
  ...
  return (
    <div
      className="notion-style-editor h-full"
      data-dropdown-menu
      style={{
        backgroundColor: props.color || (props.isSideDrawer ? "#f8fafc" : "transparent"),
        borderRadius: props.isSideDrawer ? "8px" : "0",
        padding: props.isSideDrawer ? "16px" : "0",
      }}
    >
      <EditorContent
        editor={editor}
        className="prose max-w-none focus:outline-none cursor-text h-full pb-10"
